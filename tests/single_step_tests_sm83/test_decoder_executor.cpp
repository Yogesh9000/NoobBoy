...
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d0);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d1);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d2);
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d3); NOTE: this opcode is unused
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d4);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d5);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d6);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d7);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d8);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, d9);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, da);
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, db); NOTE: this opcode is unused
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, dc);
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, dd); NOTE: this opcode is unused
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, de);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, df);

DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e0);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e1);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e2);
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e3); NOTE: this opcode is unused
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e4); NOTE: this opcode is unused
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e5);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e6);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e7);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e8);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, e9);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, ea);
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, eb); NOTE: this opcode is unused
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, ec); NOTE: this opcode is unused
// DEFINE_TEST(SINGLE_STEP_TESTS_SM83, ed); NOTE: this opcode is unused
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, ee);
DEFINE_TEST(SINGLE_STEP_TESTS_SM83, ef);
